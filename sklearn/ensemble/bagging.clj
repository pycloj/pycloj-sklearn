...
(defn abstractmethod 
  "A decorator indicating abstract methods.
    ...
    "
  [ funcobj ]
  (py/call-attr bagging "abstractmethod"  funcobj ))
...
(defn accuracy-score 
  ...
  [y_true y_pred & {:keys [normalize sample_weight]
                       :or {normalize true}} ]
    (py/call-attr-kw bagging "accuracy_score" [y_true y_pred] {:normalize normalize :sample_weight sample_weight }))
...
(defn check-classification-targets 
  "Ensure that target y is of a non-regression type.
    ...
    "
  [ y ]
  (py/call-attr bagging "check_classification_targets"  y ))
...
(defn check-consistent-length 
  "Check that all arrays have consistent first dimensions.
    ...
    *arrays : list or tuple of input objects.
    ...
    "
  [  ]
  (py/call-attr bagging "check_consistent_length"  ))
...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw bagging "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn check-random-state 
  "Turn seed into a np.random.RandomState instance
    ...
    "
  [ seed ]
  (py/call-attr bagging "check_random_state"  seed ))
...
(defn column-or-1d 
  ...
  [y & {:keys [warn]
                       :or {warn false}} ]
    (py/call-attr-kw bagging "column_or_1d" [y] {:warn warn }))

(defn delayed 
  "Decorator used to capture the arguments of a function."
  [ function check_pickle ]
  (py/call-attr bagging "delayed"  function check_pickle ))
...
(defn has-fit-parameter 
  "Checks whether the estimator's fit method supports the given parameter.
    ...
    "
  [ estimator parameter ]
  (py/call-attr bagging "has_fit_parameter"  estimator parameter ))
...
(defn if-delegate-has-method 
  "Create a decorator for methods that are delegated to a sub-estimator
    ...
    "
  [ delegate ]
  (py/call-attr bagging "if_delegate_has_method"  delegate ))
...
(defn indices-to-mask 
  "Convert list of indices to boolean mask.
    ...
    "
  [ indices mask_length ]
  (py/call-attr bagging "indices_to_mask"  indices mask_length ))
...
(defn r2-score 
  ...
  [y_true y_pred sample_weight & {:keys [multioutput]
    ...
    (py/call-attr-kw bagging "r2_score" [y_true y_pred sample_weight] {:multioutput multioutput }))
