(ns sklearn.ensemble.weight-boosting.AdaBoostClassifier
...
(defn AdaBoostClassifier 
  ...
  [base_estimator & {:keys [n_estimators learning_rate algorithm random_state]
    ...
    (py/call-attr-kw weight-boosting "AdaBoostClassifier" [base_estimator] {:n_estimators n_estimators :learning_rate learning_rate :algorithm algorithm :random_state random_state }))
