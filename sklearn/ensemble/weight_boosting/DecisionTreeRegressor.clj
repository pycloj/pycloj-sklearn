(ns sklearn.ensemble.weight-boosting.DecisionTreeRegressor
...
(defn DecisionTreeRegressor 
  "A decision tree regressor.
    ...
    array([ 0.61..., 0.57..., -0.34..., 0.41..., 0.75...,
            0.07..., 0.29..., 0.33..., -1.42..., -1.77...])
    "
  [ & {:keys [criterion splitter max_depth min_samples_split min_samples_leaf min_weight_fraction_leaf max_features random_state max_leaf_nodes min_impurity_decrease min_impurity_split presort]
       :or {criterion "mse" splitter "best" min_samples_split 2 min_samples_leaf 1 min_weight_fraction_leaf 0.0 min_impurity_decrease 0.0 presort false}} ]
  
   (py/call-attr-kw weight-boosting "DecisionTreeRegressor" [] {:criterion criterion :splitter splitter :max_depth max_depth :min_samples_split min_samples_split :min_samples_leaf min_samples_leaf :min_weight_fraction_leaf min_weight_fraction_leaf :max_features max_features :random_state random_state :max_leaf_nodes max_leaf_nodes :min_impurity_decrease min_impurity_decrease :min_impurity_split min_impurity_split :presort presort }))
