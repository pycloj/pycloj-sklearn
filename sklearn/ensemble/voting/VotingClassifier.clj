(ns sklearn.ensemble.voting.VotingClassifier
...
(defn VotingClassifier 
  ...
  [estimators & {:keys [voting weights n_jobs flatten_transform]
    ...
    (py/call-attr-kw voting "VotingClassifier" [estimators] {:voting voting :weights weights :n_jobs n_jobs :flatten_transform flatten_transform }))
