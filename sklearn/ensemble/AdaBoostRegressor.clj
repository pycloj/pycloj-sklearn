(ns sklearn.ensemble.AdaBoostRegressor
...
(defn AdaBoostRegressor 
  ...
  [base_estimator & {:keys [n_estimators learning_rate loss random_state]
    ...
    (py/call-attr-kw ensemble "AdaBoostRegressor" [base_estimator] {:n_estimators n_estimators :learning_rate learning_rate :loss loss :random_state random_state }))
