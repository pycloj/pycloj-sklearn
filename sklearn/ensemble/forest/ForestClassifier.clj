(ns sklearn.ensemble.forest.ForestClassifier
...
(defn ForestClassifier 
  ...
  [base_estimator & {:keys [n_estimators estimator_params bootstrap oob_score n_jobs random_state verbose warm_start class_weight]
    ...
    (py/call-attr-kw forest "ForestClassifier" [base_estimator] {:n_estimators n_estimators :estimator_params estimator_params :bootstrap bootstrap :oob_score oob_score :n_jobs n_jobs :random_state random_state :verbose verbose :warm_start warm_start :class_weight class_weight }))
