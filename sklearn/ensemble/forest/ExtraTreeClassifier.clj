(ns sklearn.ensemble.forest.ExtraTreeClassifier
...
(defn ExtraTreeClassifier 
  "An extremely randomized tree classifier.
    ...
    .. [1] P. Geurts, D. Ernst., and L. Wehenkel, \"Extremely randomized trees\",
           Machine Learning, 63(1), 3-42, 2006.
    "
  [ & {:keys [criterion splitter max_depth min_samples_split min_samples_leaf min_weight_fraction_leaf max_features random_state max_leaf_nodes min_impurity_decrease min_impurity_split class_weight]
       :or {criterion "gini" splitter "random" min_samples_split 2 min_samples_leaf 1 min_weight_fraction_leaf 0.0 max_features "auto" min_impurity_decrease 0.0}} ]
  
   (py/call-attr-kw forest "ExtraTreeClassifier" [] {:criterion criterion :splitter splitter :max_depth max_depth :min_samples_split min_samples_split :min_samples_leaf min_samples_leaf :min_weight_fraction_leaf min_weight_fraction_leaf :max_features max_features :random_state random_state :max_leaf_nodes max_leaf_nodes :min_impurity_decrease min_impurity_decrease :min_impurity_split min_impurity_split :class_weight class_weight }))
...
(defn predict-proba 
  ...
  [self X & {:keys [check_input]
                       :or {check_input true}} ]
    (py/call-attr-kw self "predict_proba" [X] {:check_input check_input }))
