(ns sklearn.ensemble.iforest.IsolationForest
...
(defn IsolationForest 
  ...
  [ & {:keys [n_estimators max_samples contamination max_features bootstrap n_jobs behaviour random_state verbose warm_start]
   ...
   (py/call-attr-kw iforest "IsolationForest" [] {:n_estimators n_estimators :max_samples max_samples :contamination contamination :max_features max_features :bootstrap bootstrap :n_jobs n_jobs :behaviour behaviour :random_state random_state :verbose verbose :warm_start warm_start }))
