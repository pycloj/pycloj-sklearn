(ns sklearn.ensemble.iforest.ExtraTreeRegressor
...
(defn ExtraTreeRegressor 
  "An extremely randomized tree regressor.
    ...
    .. [1] P. Geurts, D. Ernst., and L. Wehenkel, \"Extremely randomized trees\",
           Machine Learning, 63(1), 3-42, 2006.
    "
  [ & {:keys [criterion splitter max_depth min_samples_split min_samples_leaf min_weight_fraction_leaf max_features random_state min_impurity_decrease min_impurity_split max_leaf_nodes]
       :or {criterion "mse" splitter "random" min_samples_split 2 min_samples_leaf 1 min_weight_fraction_leaf 0.0 max_features "auto" min_impurity_decrease 0.0}} ]
  
   (py/call-attr-kw iforest "ExtraTreeRegressor" [] {:criterion criterion :splitter splitter :max_depth max_depth :min_samples_split min_samples_split :min_samples_leaf min_samples_leaf :min_weight_fraction_leaf min_weight_fraction_leaf :max_features max_features :random_state random_state :min_impurity_decrease min_impurity_decrease :min_impurity_split min_impurity_split :max_leaf_nodes max_leaf_nodes }))
