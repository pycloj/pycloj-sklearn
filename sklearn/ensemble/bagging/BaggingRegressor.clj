(ns sklearn.ensemble.bagging.BaggingRegressor
  "A Bagging regressor.
...
(defn BaggingRegressor 
  ...
  [base_estimator & {:keys [n_estimators max_samples max_features bootstrap bootstrap_features oob_score warm_start n_jobs random_state verbose]
    ...
    (py/call-attr-kw bagging "BaggingRegressor" [base_estimator] {:n_estimators n_estimators :max_samples max_samples :max_features max_features :bootstrap bootstrap :bootstrap_features bootstrap_features :oob_score oob_score :warm_start warm_start :n_jobs n_jobs :random_state random_state :verbose verbose }))
