(ns sklearn.manifold.spectral-embedding-.SpectralEmbedding
...
(defn SpectralEmbedding 
  ...
  [ & {:keys [n_components affinity gamma random_state eigen_solver n_neighbors n_jobs]
   ...
   (py/call-attr-kw spectral-embedding- "SpectralEmbedding" [] {:n_components n_components :affinity affinity :gamma gamma :random_state random_state :eigen_solver eigen_solver :n_neighbors n_neighbors :n_jobs n_jobs }))
