(ns sklearn.manifold.isomap.Isomap
  "Isomap Embedding
...
(defn Isomap 
  ...
  [ & {:keys [n_neighbors n_components eigen_solver tol max_iter path_method neighbors_algorithm n_jobs]
   ...
   (py/call-attr-kw isomap "Isomap" [] {:n_neighbors n_neighbors :n_components n_components :eigen_solver eigen_solver :tol tol :max_iter max_iter :path_method path_method :neighbors_algorithm neighbors_algorithm :n_jobs n_jobs }))
