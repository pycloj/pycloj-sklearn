...
(defn MDS 
  ...
  [ & {:keys [n_components metric n_init max_iter verbose eps n_jobs random_state dissimilarity]
   ...
   (py/call-attr-kw manifold "MDS" [] {:n_components n_components :metric metric :n_init n_init :max_iter max_iter :verbose verbose :eps eps :n_jobs n_jobs :random_state random_state :dissimilarity dissimilarity }))
