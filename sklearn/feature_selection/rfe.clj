(ns sklearn.feature-selection.RFE
...
(defn RFE 
  "Feature ranking with recursive feature elimination.
    ...
    .. [1] Guyon, I., Weston, J., Barnhill, S., & Vapnik, V., \"Gene selection
           ...
           Mach. Learn., 46(1-3), 389--422, 2002.
    "
  [estimator n_features_to_select & {:keys [step verbose]
                       :or {step 1 verbose 0}} ]
    (py/call-attr-kw feature-selection "RFE" [estimator n_features_to_select] {:step step :verbose verbose }))
