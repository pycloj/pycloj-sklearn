(ns sklearn.feature-selection.base.csc-matrix
  "
...
(py/initialize!)
(defonce base (import-module "sklearn.feature_selection.base"))
...
(defn csc-matrix 
  ...
  [arg1 shape dtype & {:keys [copy]
                       :or {copy false}} ]
    (py/call-attr-kw base "csc_matrix" [arg1 shape dtype] {:copy copy }))
