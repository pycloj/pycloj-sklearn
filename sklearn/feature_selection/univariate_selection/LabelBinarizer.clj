(ns sklearn.feature-selection.univariate-selection.LabelBinarizer
...
(defn LabelBinarizer 
  "Binarize labels in a one-vs-all fashion
    ...
    sklearn.preprocessing.OneHotEncoder : encode categorical features
        using a one-hot aka one-of-K scheme.
    "
  [ & {:keys [neg_label pos_label sparse_output]
       :or {neg_label 0 pos_label 1 sparse_output false}} ]
  
   (py/call-attr-kw univariate-selection "LabelBinarizer" [] {:neg_label neg_label :pos_label pos_label :sparse_output sparse_output }))
...
(defn inverse-transform 
  "Transform binary labels back to multi-class labels
        ...
        "
  [ self Y threshold ]
  (py/call-attr self "inverse_transform"  self Y threshold ))
