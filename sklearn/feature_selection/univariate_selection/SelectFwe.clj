(ns sklearn.feature-selection.univariate-selection.SelectFwe
...
(defn SelectFwe 
  "Filter: Select the p-values corresponding to Family-wise error rate
    ...
    GenericUnivariateSelect: Univariate feature selector with configurable mode.
    "
  [ & {:keys [score_func alpha]
       :or {score_func <function f_classif at 0x1a2252ab90> alpha 0.05}} ]
  
   (py/call-attr-kw univariate-selection "SelectFwe" [] {:score_func score_func :alpha alpha }))
