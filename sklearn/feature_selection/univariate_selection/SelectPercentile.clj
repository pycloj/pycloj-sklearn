(ns sklearn.feature-selection.univariate-selection.SelectPercentile
...
(defn SelectPercentile 
  "Select features according to a percentile of the highest scores.
    ...
    GenericUnivariateSelect: Univariate feature selector with configurable mode.
    "
  [ & {:keys [score_func percentile]
       :or {score_func <function f_classif at 0x1a2252ab90> percentile 10}} ]
  
   (py/call-attr-kw univariate-selection "SelectPercentile" [] {:score_func score_func :percentile percentile }))
