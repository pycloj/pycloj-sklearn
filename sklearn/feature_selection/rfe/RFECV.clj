(ns sklearn.feature-selection.rfe.RFECV
...
(defn RFECV 
  ...
  [estimator & {:keys [step min_features_to_select cv scoring verbose n_jobs]
    ...
    (py/call-attr-kw rfe "RFECV" [estimator] {:step step :min_features_to_select min_features_to_select :cv cv :scoring scoring :verbose verbose :n_jobs n_jobs }))
