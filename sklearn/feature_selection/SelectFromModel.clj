(ns sklearn.feature-selection.SelectFromModel
...
(defn SelectFromModel 
  ...
  [estimator threshold & {:keys [prefit norm_order max_features]
    ...
    (py/call-attr-kw feature-selection "SelectFromModel" [estimator threshold] {:prefit prefit :norm_order norm_order :max_features max_features }))
