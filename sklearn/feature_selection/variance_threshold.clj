(ns sklearn.feature-selection.variance-threshold
  ""
...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw variance-threshold "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw variance-threshold "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn mean-variance-axis 
  "Compute mean and variance along an axix on a CSR or CSC matrix
    ...
    "
  [ X axis ]
  (py/call-attr variance-threshold "mean_variance_axis"  X axis ))
