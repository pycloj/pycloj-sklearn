(ns sklearn.feature-selection.GenericUnivariateSelect
...
(defn GenericUnivariateSelect 
  ...
  [ & {:keys [score_func mode param]
   ...
   (py/call-attr-kw feature-selection "GenericUnivariateSelect" [] {:score_func score_func :mode mode :param param }))
