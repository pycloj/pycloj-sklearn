(ns sklearn.feature-selection.mutual-info-.NearestNeighbors
...
(py/initialize!)
(defonce mutual-info- (import-module "sklearn.feature_selection.mutual_info_"))
...
(defn NearestNeighbors 
  ...
  [ & {:keys [n_neighbors radius algorithm leaf_size metric p metric_params n_jobs]
   ...
   (py/call-attr-kw mutual-info- "NearestNeighbors" [] {:n_neighbors n_neighbors :radius radius :algorithm algorithm :leaf_size leaf_size :metric metric :p p :metric_params metric_params :n_jobs n_jobs }))
