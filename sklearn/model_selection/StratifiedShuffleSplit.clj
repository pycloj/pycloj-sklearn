(ns sklearn.model-selection.StratifiedShuffleSplit
...
(defn StratifiedShuffleSplit 
  ...
  [ & {:keys [n_splits test_size train_size random_state]
   ...
   (py/call-attr-kw model-selection "StratifiedShuffleSplit" [] {:n_splits n_splits :test_size test_size :train_size train_size :random_state random_state }))
