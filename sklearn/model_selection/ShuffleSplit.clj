(ns sklearn.model-selection.ShuffleSplit
...
(defn ShuffleSplit 
  ...
  [ & {:keys [n_splits test_size train_size random_state]
   ...
   (py/call-attr-kw model-selection "ShuffleSplit" [] {:n_splits n_splits :test_size test_size :train_size train_size :random_state random_state }))
