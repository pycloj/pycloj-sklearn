...
(defn PCA 
  ...
  [n_components & {:keys [copy whiten svd_solver tol iterated_power random_state]
    ...
    (py/call-attr-kw decomposition "PCA" [n_components] {:copy copy :whiten whiten :svd_solver svd_solver :tol tol :iterated_power iterated_power :random_state random_state }))
