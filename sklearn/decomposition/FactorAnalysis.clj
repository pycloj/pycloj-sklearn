(ns sklearn.decomposition.FactorAnalysis
  "Factor Analysis (FA)
...
(defn FactorAnalysis 
  ...
  [n_components & {:keys [tol copy max_iter noise_variance_init svd_method iterated_power random_state]
    ...
    (py/call-attr-kw decomposition "FactorAnalysis" [n_components] {:tol tol :copy copy :max_iter max_iter :noise_variance_init noise_variance_init :svd_method svd_method :iterated_power iterated_power :random_state random_state }))
