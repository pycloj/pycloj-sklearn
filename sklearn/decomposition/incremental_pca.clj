(ns sklearn.decomposition.incremental-pca
...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw incremental-pca "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn gen-batches 
  ...
  [n batch_size & {:keys [min_batch_size]
                       :or {min_batch_size 0}} ]
    (py/call-attr-kw incremental-pca "gen_batches" [n batch_size] {:min_batch_size min_batch_size }))
...
(defn svd-flip 
  ...
  [u v & {:keys [u_based_decision]
    ...
    (py/call-attr-kw incremental-pca "svd_flip" [u v] {:u_based_decision u_based_decision }))
