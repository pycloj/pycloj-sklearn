...
(defn as-float-array 
  ...
  [X & {:keys [copy force_all_finite]
    ...
    (py/call-attr-kw fastica- "as_float_array" [X] {:copy copy :force_all_finite force_all_finite }))
...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw fastica- "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw fastica- "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn check-random-state 
  "Turn seed into a np.random.RandomState instance
    ...
    "
  [ seed ]
  (py/call-attr fastica- "check_random_state"  seed ))
...
(defn fastica 
  ...
  [X n_components & {:keys [algorithm whiten fun fun_args max_iter tol w_init random_state return_X_mean compute_sources return_n_iter]
    ...
    (py/call-attr-kw fastica- "fastica" [X n_components] {:algorithm algorithm :whiten whiten :fun fun :fun_args fun_args :max_iter max_iter :tol tol :w_init w_init :random_state random_state :return_X_mean return_X_mean :compute_sources compute_sources :return_n_iter return_n_iter }))
