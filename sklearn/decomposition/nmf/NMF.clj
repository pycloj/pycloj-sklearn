(ns sklearn.decomposition.nmf.NMF
...
(py/initialize!)
(defonce nmf (import-module "sklearn.decomposition.nmf"))
...
(defn NMF 
  ...
  [n_components init & {:keys [solver beta_loss tol max_iter random_state alpha l1_ratio verbose shuffle]
    ...
    (py/call-attr-kw nmf "NMF" [n_components init] {:solver solver :beta_loss beta_loss :tol tol :max_iter max_iter :random_state random_state :alpha alpha :l1_ratio l1_ratio :verbose verbose :shuffle shuffle }))
