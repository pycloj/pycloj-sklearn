(ns sklearn.decomposition.FastICA
...
(defn FastICA 
  ...
  [n_components & {:keys [algorithm whiten fun fun_args max_iter tol w_init random_state]
    ...
    (py/call-attr-kw decomposition "FastICA" [n_components] {:algorithm algorithm :whiten whiten :fun fun :fun_args fun_args :max_iter max_iter :tol tol :w_init w_init :random_state random_state }))
