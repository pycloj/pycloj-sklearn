(ns sklearn.decomposition.truncated-svd.TruncatedSVD
...
(defn TruncatedSVD 
  ...
  [ & {:keys [n_components algorithm n_iter random_state tol]
   ...
   (py/call-attr-kw truncated-svd "TruncatedSVD" [] {:n_components n_components :algorithm algorithm :n_iter n_iter :random_state random_state :tol tol }))
