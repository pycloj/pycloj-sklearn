(ns sklearn.decomposition.SparsePCA
...
(defn SparsePCA 
  ...
  [n_components & {:keys [alpha ridge_alpha max_iter tol method n_jobs U_init V_init verbose random_state normalize_components]
    ...
    (py/call-attr-kw decomposition "SparsePCA" [n_components] {:alpha alpha :ridge_alpha ridge_alpha :max_iter max_iter :tol tol :method method :n_jobs n_jobs :U_init U_init :V_init V_init :verbose verbose :random_state random_state :normalize_components normalize_components }))
