(ns sklearn.decomposition.sparse-pca.MiniBatchSparsePCA
...
(defn MiniBatchSparsePCA 
  ...
  [n_components & {:keys [alpha ridge_alpha n_iter callback batch_size verbose shuffle n_jobs method random_state normalize_components]
    ...
    (py/call-attr-kw sparse-pca "MiniBatchSparsePCA" [n_components] {:alpha alpha :ridge_alpha ridge_alpha :n_iter n_iter :callback callback :batch_size batch_size :verbose verbose :shuffle shuffle :n_jobs n_jobs :method method :random_state random_state :normalize_components normalize_components }))
