(ns sklearn.mixture.GaussianMixture
  "Gaussian Mixture.
...
(py/initialize!)
(defonce mixture (import-module "sklearn.mixture"))
...
(defn GaussianMixture 
  ...
  [ & {:keys [n_components covariance_type tol reg_covar max_iter n_init init_params weights_init means_init precisions_init random_state warm_start verbose verbose_interval]
   ...
   (py/call-attr-kw mixture "GaussianMixture" [] {:n_components n_components :covariance_type covariance_type :tol tol :reg_covar reg_covar :max_iter max_iter :n_init n_init :init_params init_params :weights_init weights_init :means_init means_init :precisions_init precisions_init :random_state random_state :warm_start warm_start :verbose verbose :verbose_interval verbose_interval }))
