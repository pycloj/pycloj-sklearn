(ns sklearn.mixture.base.BaseMixture
...
(py/initialize!)
(defonce base (import-module "sklearn.mixture.base"))
...
(defn BaseMixture 
  ...
  (py/call-attr base "BaseMixture"  n_components tol reg_covar max_iter n_init init_params random_state warm_start verbose verbose_interval ))
