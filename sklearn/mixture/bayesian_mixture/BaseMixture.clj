(ns sklearn.mixture.bayesian-mixture.BaseMixture
...
(defn BaseMixture 
  ...
  (py/call-attr bayesian-mixture "BaseMixture"  n_components tol reg_covar max_iter n_init init_params random_state warm_start verbose verbose_interval ))
