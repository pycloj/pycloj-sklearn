(ns sklearn.preprocessing.data.RobustScaler
...
(defn RobustScaler 
  ...
  [ & {:keys [with_centering with_scaling quantile_range copy]
   ...
   (py/call-attr-kw data "RobustScaler" [] {:with_centering with_centering :with_scaling with_scaling :quantile_range quantile_range :copy copy }))
