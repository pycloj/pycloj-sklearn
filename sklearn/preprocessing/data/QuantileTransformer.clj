(ns sklearn.preprocessing.data.QuantileTransformer
...
(defn QuantileTransformer 
  ...
  [ & {:keys [n_quantiles output_distribution ignore_implicit_zeros subsample random_state copy]
   ...
   (py/call-attr-kw data "QuantileTransformer" [] {:n_quantiles n_quantiles :output_distribution output_distribution :ignore_implicit_zeros ignore_implicit_zeros :subsample subsample :random_state random_state :copy copy }))
