(ns sklearn.preprocessing.data.OneHotEncoder
...
(defn OneHotEncoder 
  ...
  [n_values categorical_features categories drop & {:keys [sparse dtype handle_unknown]
    ...
    (py/call-attr-kw data "OneHotEncoder" [n_values categorical_features categories drop] {:sparse sparse :dtype dtype :handle_unknown handle_unknown }))
