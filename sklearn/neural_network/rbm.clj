...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw rbm "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw rbm "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn check-random-state 
  "Turn seed into a np.random.RandomState instance
    ...
    "
  [ seed ]
  (py/call-attr rbm "check_random_state"  seed ))
...
(defn gen-even-slices 
  "Generator to create n_packs slices going up to n.
    ...
    "
  [ n n_packs n_samples ]
  (py/call-attr rbm "gen_even_slices"  n n_packs n_samples ))
...
(defn log-logistic 
  "Compute the log of the logistic function, ``log(1 / (1 + e ** -x))``.
    ...
    "
  [ X out ]
  (py/call-attr rbm "log_logistic"  X out ))
...
(defn safe-sparse-dot 
  ...
  [a b & {:keys [dense_output]
    ...
    (py/call-attr-kw rbm "safe_sparse_dot" [a b] {:dense_output dense_output }))
