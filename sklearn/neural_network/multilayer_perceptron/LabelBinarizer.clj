(ns sklearn.neural-network.multilayer-perceptron.LabelBinarizer
...
(defn LabelBinarizer 
  ...
  [ & {:keys [neg_label pos_label sparse_output]
   ...
   (py/call-attr-kw multilayer-perceptron "LabelBinarizer" [] {:neg_label neg_label :pos_label pos_label :sparse_output sparse_output }))
