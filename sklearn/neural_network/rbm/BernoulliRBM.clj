(ns sklearn.neural-network.rbm.BernoulliRBM
...
(py/initialize!)
(defonce rbm (import-module "sklearn.neural_network.rbm"))
...
(defn BernoulliRBM 
  ...
  [ & {:keys [n_components learning_rate batch_size n_iter verbose random_state]
   ...
   (py/call-attr-kw rbm "BernoulliRBM" [] {:n_components n_components :learning_rate learning_rate :batch_size batch_size :n_iter n_iter :verbose verbose :random_state random_state }))
