(ns sklearn.cluster.AffinityPropagation
...
(defn AffinityPropagation 
  ...
  [ & {:keys [damping max_iter convergence_iter copy preference affinity verbose]
   ...
   (py/call-attr-kw cluster "AffinityPropagation" [] {:damping damping :max_iter max_iter :convergence_iter convergence_iter :copy copy :preference preference :affinity affinity :verbose verbose }))
