(ns sklearn.cluster.bicluster.SpectralCoclustering
...
(defn SpectralCoclustering 
  ...
  [ & {:keys [n_clusters svd_method n_svd_vecs mini_batch init n_init n_jobs random_state]
   ...
   (py/call-attr-kw bicluster "SpectralCoclustering" [] {:n_clusters n_clusters :svd_method svd_method :n_svd_vecs n_svd_vecs :mini_batch mini_batch :init init :n_init n_init :n_jobs n_jobs :random_state random_state }))
