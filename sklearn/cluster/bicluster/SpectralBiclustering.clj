(ns sklearn.cluster.bicluster.SpectralBiclustering
...
(defn SpectralBiclustering 
  ...
  [ & {:keys [n_clusters method n_components n_best svd_method n_svd_vecs mini_batch init n_init n_jobs random_state]
   ...
   (py/call-attr-kw bicluster "SpectralBiclustering" [] {:n_clusters n_clusters :method method :n_components n_components :n_best n_best :svd_method svd_method :n_svd_vecs n_svd_vecs :mini_batch mini_batch :init init :n_init n_init :n_jobs n_jobs :random_state random_state }))
