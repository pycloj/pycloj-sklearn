(ns sklearn.cluster.dbscan-.DBSCAN
...
(defn DBSCAN 
  ...
  [ & {:keys [eps min_samples metric metric_params algorithm leaf_size p n_jobs]
   ...
   (py/call-attr-kw dbscan- "DBSCAN" [] {:eps eps :min_samples min_samples :metric metric :metric_params metric_params :algorithm algorithm :leaf_size leaf_size :p p :n_jobs n_jobs }))
