(ns sklearn.cluster.AgglomerativeClustering
  "
...
(defn AgglomerativeClustering 
  ...
  [ & {:keys [n_clusters affinity memory connectivity compute_full_tree linkage pooling_func distance_threshold]
   ...
   (py/call-attr-kw cluster "AgglomerativeClustering" [] {:n_clusters n_clusters :affinity affinity :memory memory :connectivity connectivity :compute_full_tree compute_full_tree :linkage linkage :pooling_func pooling_func :distance_threshold distance_threshold }))
