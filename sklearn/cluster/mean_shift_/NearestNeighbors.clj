(ns sklearn.cluster.mean-shift-.NearestNeighbors
...
(defn NearestNeighbors 
  ...
  [ & {:keys [n_neighbors radius algorithm leaf_size metric p metric_params n_jobs]
   ...
   (py/call-attr-kw mean-shift- "NearestNeighbors" [] {:n_neighbors n_neighbors :radius radius :algorithm algorithm :leaf_size leaf_size :metric metric :p p :metric_params metric_params :n_jobs n_jobs }))
