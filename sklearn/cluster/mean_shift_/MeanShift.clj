(ns sklearn.cluster.mean-shift-.MeanShift
...
(defn MeanShift 
  ...
  [bandwidth seeds & {:keys [bin_seeding min_bin_freq cluster_all n_jobs]
    ...
    (py/call-attr-kw mean-shift- "MeanShift" [bandwidth seeds] {:bin_seeding bin_seeding :min_bin_freq min_bin_freq :cluster_all cluster_all :n_jobs n_jobs }))
