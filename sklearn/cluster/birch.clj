...
(defn Birch 
  ...
  [ & {:keys [threshold branching_factor n_clusters compute_labels copy]
   ...
   (py/call-attr-kw cluster "Birch" [] {:threshold threshold :branching_factor branching_factor :n_clusters n_clusters :compute_labels compute_labels :copy copy }))
