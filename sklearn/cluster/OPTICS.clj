...
(defn OPTICS 
  ...
  [ & {:keys [min_samples max_eps metric p metric_params cluster_method eps xi predecessor_correction min_cluster_size algorithm leaf_size n_jobs]
   ...
   (py/call-attr-kw cluster "OPTICS" [] {:min_samples min_samples :max_eps max_eps :metric metric :p p :metric_params metric_params :cluster_method cluster_method :eps eps :xi xi :predecessor_correction predecessor_correction :min_cluster_size min_cluster_size :algorithm algorithm :leaf_size leaf_size :n_jobs n_jobs }))
