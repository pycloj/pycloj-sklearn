(ns sklearn.gaussian-process.gpc.GaussianProcessClassifier
...
(defn GaussianProcessClassifier 
  ...
  [kernel & {:keys [optimizer n_restarts_optimizer max_iter_predict warm_start copy_X_train random_state multi_class n_jobs]
    ...
    (py/call-attr-kw gpc "GaussianProcessClassifier" [kernel] {:optimizer optimizer :n_restarts_optimizer n_restarts_optimizer :max_iter_predict max_iter_predict :warm_start warm_start :copy_X_train copy_X_train :random_state random_state :multi_class multi_class :n_jobs n_jobs }))
