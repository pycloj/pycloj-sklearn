(ns sklearn.gaussian-process.kernels.WhiteKernel
  "White kernel.
...
(defn WhiteKernel 
  "White kernel.
    ...
    "
  [ & {:keys [noise_level noise_level_bounds]
       :or {noise_level 1.0 noise_level_bounds (1e-05, 100000.0)}} ]
  
   (py/call-attr-kw kernels "WhiteKernel" [] {:noise_level noise_level :noise_level_bounds noise_level_bounds }))
...
(defn hyperparameter-noise-level 
  ""
  [ self ]
    (py/call-attr self "hyperparameter_noise_level"))
