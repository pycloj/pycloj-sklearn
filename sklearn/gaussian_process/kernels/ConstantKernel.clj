(ns sklearn.gaussian-process.kernels.ConstantKernel
  "Constant kernel.
...
(defn ConstantKernel 
  ...
  [ & {:keys [constant_value constant_value_bounds]
   ...
   (py/call-attr-kw kernels "ConstantKernel" [] {:constant_value constant_value :constant_value_bounds constant_value_bounds }))
