...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw multiclass "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn check-random-state 
  "Turn seed into a np.random.RandomState instance
    ...
    "
  [ seed ]
  (py/call-attr multiclass "check_random_state"  seed ))
...
(defn clone 
  ...
  [estimator & {:keys [safe]
                       :or {safe true}} ]
    (py/call-attr-kw multiclass "clone" [estimator] {:safe safe }))

(defn delayed 
  "Decorator used to capture the arguments of a function."
  [ function check_pickle ]
  (py/call-attr multiclass "delayed"  function check_pickle ))
...
(defn euclidean-distances 
  ...
  [X Y Y_norm_squared & {:keys [squared X_norm_squared]
                       :or {squared false}} ]
    (py/call-attr-kw multiclass "euclidean_distances" [X Y Y_norm_squared] {:squared squared :X_norm_squared X_norm_squared }))
...
(defn if-delegate-has-method 
  "Create a decorator for methods that are delegated to a sub-estimator
    ...
    "
  [ delegate ]
  (py/call-attr multiclass "if_delegate_has_method"  delegate ))
...
(defn is-classifier 
  "Returns True if the given estimator is (probably) a classifier.
    ...
    "
  [ estimator ]
  (py/call-attr multiclass "is_classifier"  estimator ))
...
(defn is-regressor 
  "Returns True if the given estimator is (probably) a regressor.
    ...
    "
  [ estimator ]
  (py/call-attr multiclass "is_regressor"  estimator ))
