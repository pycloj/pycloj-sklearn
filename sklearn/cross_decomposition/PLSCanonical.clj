(ns sklearn.cross-decomposition.PLSCanonical
...
(py/initialize!)
(defonce cross-decomposition (import-module "sklearn.cross_decomposition"))
...
(defn PLSCanonical 
  ...
  [ & {:keys [n_components scale algorithm max_iter tol copy]
   ...
   (py/call-attr-kw cross-decomposition "PLSCanonical" [] {:n_components n_components :scale scale :algorithm algorithm :max_iter max_iter :tol tol :copy copy }))
