...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw dummy "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn check-consistent-length 
  "Check that all arrays have consistent first dimensions.
    ...
    *arrays : list or tuple of input objects.
    ...
    "
  [  ]
  (py/call-attr dummy "check_consistent_length"  ))
...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw dummy "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn check-random-state 
  "Turn seed into a np.random.RandomState instance
    ...
    "
  [ seed ]
  (py/call-attr dummy "check_random_state"  seed ))

(defn class-distribution 
  "Compute class priors from multioutput-multiclass target data
    ...
    "
  [ y sample_weight ]
  (py/call-attr dummy "class_distribution"  y sample_weight ))
...
(defn random-choice-csc 
  ...
  (py/call-attr dummy "random_choice_csc"  n_samples classes class_probability random_state ))
