(ns sklearn.linear-model.ransac
  ""
...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw ransac "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn check-consistent-length 
  "Check that all arrays have consistent first dimensions.
    ...
    *arrays : list or tuple of input objects.
    ...
    "
  [  ]
  (py/call-attr ransac "check_consistent_length"  ))
...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw ransac "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn check-random-state 
  "Turn seed into a np.random.RandomState instance
    ...
    "
  [ seed ]
  (py/call-attr ransac "check_random_state"  seed ))
...
(defn clone 
  ...
  [estimator & {:keys [safe]
                       :or {safe true}} ]
    (py/call-attr-kw ransac "clone" [estimator] {:safe safe }))
...
(defn has-fit-parameter 
  "Checks whether the estimator's fit method supports the given parameter.
    ...
    "
  [ estimator parameter ]
  (py/call-attr ransac "has_fit_parameter"  estimator parameter ))
