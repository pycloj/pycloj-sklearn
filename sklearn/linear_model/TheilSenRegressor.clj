(ns sklearn.linear-model.TheilSenRegressor
...
(defn TheilSenRegressor 
  ...
  [ & {:keys [fit_intercept copy_X max_subpopulation n_subsamples max_iter tol random_state n_jobs verbose]
   ...
   (py/call-attr-kw linear-model "TheilSenRegressor" [] {:fit_intercept fit_intercept :copy_X copy_X :max_subpopulation max_subpopulation :n_subsamples n_subsamples :max_iter max_iter :tol tol :random_state random_state :n_jobs n_jobs :verbose verbose }))
