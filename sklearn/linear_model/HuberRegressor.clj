(ns sklearn.linear-model.HuberRegressor
...
(defn HuberRegressor 
  ...
  [ & {:keys [epsilon max_iter alpha warm_start fit_intercept tol]
   ...
   (py/call-attr-kw linear-model "HuberRegressor" [] {:epsilon epsilon :max_iter max_iter :alpha alpha :warm_start warm_start :fit_intercept fit_intercept :tol tol }))
