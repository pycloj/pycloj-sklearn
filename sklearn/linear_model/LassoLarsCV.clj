(ns sklearn.linear-model.LassoLarsCV
...
(defn LassoLarsCV 
  ...
  [ & {:keys [fit_intercept verbose max_iter normalize precompute cv max_n_alphas n_jobs eps copy_X positive]
   ...
   (py/call-attr-kw linear-model "LassoLarsCV" [] {:fit_intercept fit_intercept :verbose verbose :max_iter max_iter :normalize normalize :precompute precompute :cv cv :max_n_alphas max_n_alphas :n_jobs n_jobs :eps eps :copy_X copy_X :positive positive }))
