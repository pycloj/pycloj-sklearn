(ns sklearn.linear-model.MultiTaskElasticNetCV
...
(defn MultiTaskElasticNetCV 
  ...
  [ & {:keys [l1_ratio eps n_alphas alphas fit_intercept normalize max_iter tol cv copy_X verbose n_jobs random_state selection]
   ...
   (py/call-attr-kw linear-model "MultiTaskElasticNetCV" [] {:l1_ratio l1_ratio :eps eps :n_alphas n_alphas :alphas alphas :fit_intercept fit_intercept :normalize normalize :max_iter max_iter :tol tol :cv cv :copy_X copy_X :verbose verbose :n_jobs n_jobs :random_state random_state :selection selection }))
