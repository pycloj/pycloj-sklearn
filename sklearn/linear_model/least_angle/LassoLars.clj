(ns sklearn.linear-model.least-angle.LassoLars
...
(defn LassoLars 
  ...
  [ & {:keys [alpha fit_intercept verbose normalize precompute max_iter eps copy_X fit_path positive]
   ...
   (py/call-attr-kw least-angle "LassoLars" [] {:alpha alpha :fit_intercept fit_intercept :verbose verbose :normalize normalize :precompute precompute :max_iter max_iter :eps eps :copy_X copy_X :fit_path fit_path :positive positive }))
