(ns sklearn.linear-model.least-angle.Lars
...
(defn Lars 
  ...
  [ & {:keys [fit_intercept verbose normalize precompute n_nonzero_coefs eps copy_X fit_path positive]
   ...
   (py/call-attr-kw least-angle "Lars" [] {:fit_intercept fit_intercept :verbose verbose :normalize normalize :precompute precompute :n_nonzero_coefs n_nonzero_coefs :eps eps :copy_X copy_X :fit_path fit_path :positive positive }))
