(ns sklearn.linear-model.coordinate-descent.ElasticNetCV
...
(defn ElasticNetCV 
  "Elastic Net model with iterative fitting along a regularization path.
    ...
    "
  [ & {:keys [l1_ratio eps n_alphas alphas fit_intercept normalize precompute max_iter tol cv copy_X verbose n_jobs positive random_state selection]
       :or {l1_ratio 0.5 eps 0.001 n_alphas 100 fit_intercept true normalize false precompute "auto" max_iter 1000 tol 0.0001 cv "warn" copy_X true verbose 0 positive false selection "cyclic"}} ]
  
   (py/call-attr-kw coordinate-descent "ElasticNetCV" [] {:l1_ratio l1_ratio :eps eps :n_alphas n_alphas :alphas alphas :fit_intercept fit_intercept :normalize normalize :precompute precompute :max_iter max_iter :tol tol :cv cv :copy_X copy_X :verbose verbose :n_jobs n_jobs :positive positive :random_state random_state :selection selection }))
