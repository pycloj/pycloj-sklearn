(ns sklearn.linear-model.coordinate-descent.MultiTaskLasso
...
(defn MultiTaskLasso 
  "Multi-task Lasso model trained with L1/L2 mixed-norm as regularizer.
    ...
    should be directly passed as a Fortran-contiguous numpy array.
    "
  [ & {:keys [alpha fit_intercept normalize copy_X max_iter tol warm_start random_state selection]
       :or {alpha 1.0 fit_intercept true normalize false copy_X true max_iter 1000 tol 0.0001 warm_start false selection "cyclic"}} ]
  
   (py/call-attr-kw coordinate-descent "MultiTaskLasso" [] {:alpha alpha :fit_intercept fit_intercept :normalize normalize :copy_X copy_X :max_iter max_iter :tol tol :warm_start warm_start :random_state random_state :selection selection }))
