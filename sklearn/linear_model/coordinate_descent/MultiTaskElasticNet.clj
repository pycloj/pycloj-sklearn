(ns sklearn.linear-model.coordinate-descent.MultiTaskElasticNet
...
(defn MultiTaskElasticNet 
  "Multi-task ElasticNet model trained with L1/L2 mixed-norm as regularizer
    ...
    should be directly passed as a Fortran-contiguous numpy array.
    "
  [ & {:keys [alpha l1_ratio fit_intercept normalize copy_X max_iter tol warm_start random_state selection]
       :or {alpha 1.0 l1_ratio 0.5 fit_intercept true normalize false copy_X true max_iter 1000 tol 0.0001 warm_start false selection "cyclic"}} ]
  
   (py/call-attr-kw coordinate-descent "MultiTaskElasticNet" [] {:alpha alpha :l1_ratio l1_ratio :fit_intercept fit_intercept :normalize normalize :copy_X copy_X :max_iter max_iter :tol tol :warm_start warm_start :random_state random_state :selection selection }))
