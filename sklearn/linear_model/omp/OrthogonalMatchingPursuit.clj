(ns sklearn.linear-model.omp.OrthogonalMatchingPursuit
...
(defn OrthogonalMatchingPursuit 
  ...
  [n_nonzero_coefs tol & {:keys [fit_intercept normalize precompute]
    ...
    (py/call-attr-kw omp "OrthogonalMatchingPursuit" [n_nonzero_coefs tol] {:fit_intercept fit_intercept :normalize normalize :precompute precompute }))
