(ns sklearn.linear-model.RidgeClassifierCV
...
(defn RidgeClassifierCV 
  ...
  [ & {:keys [alphas fit_intercept normalize scoring cv class_weight store_cv_values]
   ...
   (py/call-attr-kw linear-model "RidgeClassifierCV" [] {:alphas alphas :fit_intercept fit_intercept :normalize normalize :scoring scoring :cv cv :class_weight class_weight :store_cv_values store_cv_values }))
