(ns sklearn.linear-model.bayes.BayesianRidge
...
(defn BayesianRidge 
  ...
  [ & {:keys [n_iter tol alpha_1 alpha_2 lambda_1 lambda_2 compute_score fit_intercept normalize copy_X verbose]
   ...
   (py/call-attr-kw bayes "BayesianRidge" [] {:n_iter n_iter :tol tol :alpha_1 alpha_1 :alpha_2 alpha_2 :lambda_1 lambda_1 :lambda_2 lambda_2 :compute_score compute_score :fit_intercept fit_intercept :normalize normalize :copy_X copy_X :verbose verbose }))
