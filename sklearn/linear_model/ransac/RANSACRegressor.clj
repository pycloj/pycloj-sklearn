(ns sklearn.linear-model.ransac.RANSACRegressor
...
(defn RANSACRegressor 
  ...
  [base_estimator min_samples residual_threshold is_data_valid is_model_valid & {:keys [max_trials max_skips stop_n_inliers stop_score stop_probability loss random_state]
    ...
    (py/call-attr-kw ransac "RANSACRegressor" [base_estimator min_samples residual_threshold is_data_valid is_model_valid] {:max_trials max_trials :max_skips max_skips :stop_n_inliers stop_n_inliers :stop_score stop_score :stop_probability stop_probability :loss loss :random_state random_state }))
