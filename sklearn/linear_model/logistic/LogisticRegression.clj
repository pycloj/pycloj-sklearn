(ns sklearn.linear-model.logistic.LogisticRegression
...
(defn LogisticRegression 
  ...
  [ & {:keys [penalty dual tol C fit_intercept intercept_scaling class_weight random_state solver max_iter multi_class verbose warm_start n_jobs l1_ratio]
   ...
   (py/call-attr-kw logistic "LogisticRegression" [] {:penalty penalty :dual dual :tol tol :C C :fit_intercept fit_intercept :intercept_scaling intercept_scaling :class_weight class_weight :random_state random_state :solver solver :max_iter max_iter :multi_class multi_class :verbose verbose :warm_start warm_start :n_jobs n_jobs :l1_ratio l1_ratio }))
