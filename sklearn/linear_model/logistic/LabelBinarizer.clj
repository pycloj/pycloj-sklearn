(ns sklearn.linear-model.logistic.LabelBinarizer
...
(defn LabelBinarizer 
  ...
  [ & {:keys [neg_label pos_label sparse_output]
   ...
   (py/call-attr-kw logistic "LabelBinarizer" [] {:neg_label neg_label :pos_label pos_label :sparse_output sparse_output }))
