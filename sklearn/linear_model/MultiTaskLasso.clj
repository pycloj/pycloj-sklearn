(ns sklearn.linear-model.MultiTaskLasso
...
(defn MultiTaskLasso 
  ...
  [ & {:keys [alpha fit_intercept normalize copy_X max_iter tol warm_start random_state selection]
   ...
   (py/call-attr-kw linear-model "MultiTaskLasso" [] {:alpha alpha :fit_intercept fit_intercept :normalize normalize :copy_X copy_X :max_iter max_iter :tol tol :warm_start warm_start :random_state random_state :selection selection }))
