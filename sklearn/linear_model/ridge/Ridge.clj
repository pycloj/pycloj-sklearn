(ns sklearn.linear-model.ridge.Ridge
...
(defn Ridge 
  ...
  [ & {:keys [alpha fit_intercept normalize copy_X max_iter tol solver random_state]
   ...
   (py/call-attr-kw ridge "Ridge" [] {:alpha alpha :fit_intercept fit_intercept :normalize normalize :copy_X copy_X :max_iter max_iter :tol tol :solver solver :random_state random_state }))
