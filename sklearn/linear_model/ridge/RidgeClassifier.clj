(ns sklearn.linear-model.ridge.RidgeClassifier
...
(defn RidgeClassifier 
  ...
  [ & {:keys [alpha fit_intercept normalize copy_X max_iter tol class_weight solver random_state]
   ...
   (py/call-attr-kw ridge "RidgeClassifier" [] {:alpha alpha :fit_intercept fit_intercept :normalize normalize :copy_X copy_X :max_iter max_iter :tol tol :class_weight class_weight :solver solver :random_state random_state }))
