(ns sklearn.linear-model.PassiveAggressiveRegressor
...
(defn PassiveAggressiveRegressor 
  ...
  [ & {:keys [C fit_intercept max_iter tol early_stopping validation_fraction n_iter_no_change shuffle verbose loss epsilon random_state warm_start average]
   ...
   (py/call-attr-kw linear-model "PassiveAggressiveRegressor" [] {:C C :fit_intercept fit_intercept :max_iter max_iter :tol tol :early_stopping early_stopping :validation_fraction validation_fraction :n_iter_no_change n_iter_no_change :shuffle shuffle :verbose verbose :loss loss :epsilon epsilon :random_state random_state :warm_start warm_start :average average }))
