...
(defn as-float-array 
  ...
  [X & {:keys [copy force_all_finite]
    ...
    (py/call-attr-kw omp "as_float_array" [X] {:copy copy :force_all_finite force_all_finite }))
...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw omp "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn check-cv 
  ...
  [ & {:keys [cv y classifier]
   ...
   (py/call-attr-kw omp "check_cv" [] {:cv cv :y y :classifier classifier }))

(defn delayed 
  "Decorator used to capture the arguments of a function."
  [ function check_pickle ]
  (py/call-attr omp "delayed"  function check_pickle ))
...
(defn get-lapack-funcs 
  ...
  [names & {:keys [arrays dtype]
                       :or {arrays ()}} ]
    (py/call-attr-kw omp "get_lapack_funcs" [names] {:arrays arrays :dtype dtype }))
...
(defn orthogonal-mp 
  ...
  [X y n_nonzero_coefs tol & {:keys [precompute copy_X return_path return_n_iter]
    ...
    (py/call-attr-kw omp "orthogonal_mp" [X y n_nonzero_coefs tol] {:precompute precompute :copy_X copy_X :return_path return_path :return_n_iter return_n_iter }))
...
(defn orthogonal-mp-gram 
  ...
  [Gram Xy n_nonzero_coefs tol norms_squared & {:keys [copy_Gram copy_Xy return_path return_n_iter]
    ...
    (py/call-attr-kw omp "orthogonal_mp_gram" [Gram Xy n_nonzero_coefs tol norms_squared] {:copy_Gram copy_Gram :copy_Xy copy_Xy :return_path return_path :return_n_iter return_n_iter }))
