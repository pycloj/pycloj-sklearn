...
(defn buchheim 
  ""
  [ tree ]
  (py/call-attr export "buchheim"  tree ))
...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw export "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn export-graphviz 
  ...
  [decision_tree out_file max_depth feature_names class_names & {:keys [label filled leaves_parallel impurity node_ids proportion rotate rounded special_characters precision]
    ...
    (py/call-attr-kw export "export_graphviz" [decision_tree out_file max_depth feature_names class_names] {:label label :filled filled :leaves_parallel leaves_parallel :impurity impurity :node_ids node_ids :proportion proportion :rotate rotate :rounded rounded :special_characters special_characters :precision precision }))
...
(defn export-text 
  ...
  [decision_tree feature_names & {:keys [max_depth spacing decimals show_weights]
    ...
    (py/call-attr-kw export "export_text" [decision_tree feature_names] {:max_depth max_depth :spacing spacing :decimals decimals :show_weights show_weights }))
...
(defn plot-tree 
  ...
  [decision_tree max_depth feature_names class_names & {:keys [label filled impurity node_ids proportion rotate rounded precision ax fontsize]
    ...
    (py/call-attr-kw export "plot_tree" [decision_tree max_depth feature_names class_names] {:label label :filled filled :impurity impurity :node_ids node_ids :proportion proportion :rotate rotate :rounded rounded :precision precision :ax ax :fontsize fontsize }))
