(ns sklearn.semi-supervised.label-propagation.LabelSpreading
...
(defn LabelSpreading 
  ...
  [ & {:keys [kernel gamma n_neighbors alpha max_iter tol n_jobs]
   ...
   (py/call-attr-kw label-propagation "LabelSpreading" [] {:kernel kernel :gamma gamma :n_neighbors n_neighbors :alpha alpha :max_iter max_iter :tol tol :n_jobs n_jobs }))
