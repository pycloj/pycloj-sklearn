(ns sklearn.semi-supervised.label-propagation.LabelPropagation
...
(defn LabelPropagation 
  ...
  [ & {:keys [kernel gamma n_neighbors max_iter tol n_jobs]
   ...
   (py/call-attr-kw label-propagation "LabelPropagation" [] {:kernel kernel :gamma gamma :n_neighbors n_neighbors :max_iter max_iter :tol tol :n_jobs n_jobs }))
