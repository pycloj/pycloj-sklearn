...
(defn OneClassSVM 
  ...
  [ & {:keys [kernel degree gamma coef0 tol nu shrinking cache_size verbose max_iter random_state]
   ...
   (py/call-attr-kw svm "OneClassSVM" [] {:kernel kernel :degree degree :gamma gamma :coef0 coef0 :tol tol :nu nu :shrinking shrinking :cache_size cache_size :verbose verbose :max_iter max_iter :random_state random_state }))
