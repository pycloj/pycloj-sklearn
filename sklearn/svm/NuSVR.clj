...
(defn NuSVR 
  ...
  [ & {:keys [nu C kernel degree gamma coef0 shrinking tol cache_size verbose max_iter]
   ...
   (py/call-attr-kw svm "NuSVR" [] {:nu nu :C C :kernel kernel :degree degree :gamma gamma :coef0 coef0 :shrinking shrinking :tol tol :cache_size cache_size :verbose verbose :max_iter max_iter }))
