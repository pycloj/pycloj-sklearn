(ns sklearn.svm.classes.LinearSVC
...
(defn LinearSVC 
  ...
  [ & {:keys [penalty loss dual tol C multi_class fit_intercept intercept_scaling class_weight verbose random_state max_iter]
   ...
   (py/call-attr-kw classes "LinearSVC" [] {:penalty penalty :loss loss :dual dual :tol tol :C C :multi_class multi_class :fit_intercept fit_intercept :intercept_scaling intercept_scaling :class_weight class_weight :verbose verbose :random_state random_state :max_iter max_iter }))
