(ns sklearn.svm.classes.LinearSVR
...
(defn LinearSVR 
  ...
  [ & {:keys [epsilon tol C loss fit_intercept intercept_scaling dual verbose random_state max_iter]
   ...
   (py/call-attr-kw classes "LinearSVR" [] {:epsilon epsilon :tol tol :C C :loss loss :fit_intercept fit_intercept :intercept_scaling intercept_scaling :dual dual :verbose verbose :random_state random_state :max_iter max_iter }))
