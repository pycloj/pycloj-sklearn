(ns sklearn.svm.classes.BaseSVC
...
(defn BaseSVC 
  ...
  (py/call-attr classes "BaseSVC"  kernel degree gamma coef0 tol C nu shrinking probability cache_size class_weight verbose max_iter decision_function_shape random_state ))
