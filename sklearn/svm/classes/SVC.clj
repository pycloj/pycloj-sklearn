...
(defn SVC 
  ...
  [ & {:keys [C kernel degree gamma coef0 shrinking probability tol cache_size class_weight verbose max_iter decision_function_shape random_state]
   ...
   (py/call-attr-kw classes "SVC" [] {:C C :kernel kernel :degree degree :gamma gamma :coef0 coef0 :shrinking shrinking :probability probability :tol tol :cache_size cache_size :class_weight class_weight :verbose verbose :max_iter max_iter :decision_function_shape decision_function_shape :random_state random_state }))
