(ns sklearn.svm.classes.BaseLibSVM
...
(defn BaseLibSVM 
  ...
  (py/call-attr classes "BaseLibSVM"  kernel degree gamma coef0 tol C nu epsilon shrinking probability cache_size class_weight verbose max_iter random_state ))
