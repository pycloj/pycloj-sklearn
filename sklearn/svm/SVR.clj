...
(defn SVR 
  ...
  [ & {:keys [kernel degree gamma coef0 tol C epsilon shrinking cache_size verbose max_iter]
   ...
   (py/call-attr-kw svm "SVR" [] {:kernel kernel :degree degree :gamma gamma :coef0 coef0 :tol tol :C C :epsilon epsilon :shrinking shrinking :cache_size cache_size :verbose verbose :max_iter max_iter }))
