(ns sklearn.feature-extraction.dict-vectorizer
  ""
...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw dict-vectorizer "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn tosequence 
  "Cast iterable x to a Sequence, avoiding a copy if possible.
    ...
    "
  [ x ]
  (py/call-attr dict-vectorizer "tosequence"  x ))
