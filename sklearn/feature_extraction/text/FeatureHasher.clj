(ns sklearn.feature-extraction.text.FeatureHasher
...
(defn FeatureHasher 
  ...
  [ & {:keys [n_features input_type dtype alternate_sign]
   ...
   (py/call-attr-kw text "FeatureHasher" [] {:n_features n_features :input_type input_type :dtype dtype :alternate_sign alternate_sign }))
