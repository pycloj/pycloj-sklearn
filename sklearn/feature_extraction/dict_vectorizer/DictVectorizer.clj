(ns sklearn.feature-extraction.dict-vectorizer.DictVectorizer
...
(defn DictVectorizer 
  ...
  [ & {:keys [dtype separator sparse sort]
   ...
   (py/call-attr-kw dict-vectorizer "DictVectorizer" [] {:dtype dtype :separator separator :sparse sparse :sort sort }))
