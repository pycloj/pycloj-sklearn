(ns sklearn.feature-extraction.FeatureHasher
...
(defn FeatureHasher 
  ...
  [ & {:keys [n_features input_type dtype alternate_sign]
   ...
   (py/call-attr-kw feature-extraction "FeatureHasher" [] {:n_features n_features :input_type input_type :dtype dtype :alternate_sign alternate_sign }))
