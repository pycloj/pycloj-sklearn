(ns sklearn.covariance.GraphicalLassoCV
...
(defn GraphicalLassoCV 
  ...
  [ & {:keys [alphas n_refinements cv tol enet_tol max_iter mode n_jobs verbose assume_centered]
   ...
   (py/call-attr-kw covariance "GraphicalLassoCV" [] {:alphas alphas :n_refinements n_refinements :cv cv :tol tol :enet_tol enet_tol :max_iter max_iter :mode mode :n_jobs n_jobs :verbose verbose :assume_centered assume_centered }))
