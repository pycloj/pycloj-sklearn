(ns sklearn.covariance.EmpiricalCovariance
...
(defn EmpiricalCovariance 
  ...
  [ & {:keys [store_precision assume_centered]
   ...
   (py/call-attr-kw covariance "EmpiricalCovariance" [] {:store_precision store_precision :assume_centered assume_centered }))
