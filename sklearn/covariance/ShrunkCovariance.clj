(ns sklearn.covariance.ShrunkCovariance
...
(defn ShrunkCovariance 
  ...
  [ & {:keys [store_precision assume_centered shrinkage]
   ...
   (py/call-attr-kw covariance "ShrunkCovariance" [] {:store_precision store_precision :assume_centered assume_centered :shrinkage shrinkage }))
