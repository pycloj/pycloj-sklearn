(ns sklearn.covariance.graph-lasso-.Parallel
...
(defn Parallel 
  ...
  [n_jobs backend & {:keys [verbose timeout pre_dispatch batch_size temp_folder max_nbytes mmap_mode prefer require]
    ...
    (py/call-attr-kw graph-lasso- "Parallel" [n_jobs backend] {:verbose verbose :timeout timeout :pre_dispatch pre_dispatch :batch_size batch_size :temp_folder temp_folder :max_nbytes max_nbytes :mmap_mode mmap_mode :prefer prefer :require require }))
