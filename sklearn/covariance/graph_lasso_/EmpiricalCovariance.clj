(ns sklearn.covariance.graph-lasso-.EmpiricalCovariance
...
(defn EmpiricalCovariance 
  ...
  [ & {:keys [store_precision assume_centered]
   ...
   (py/call-attr-kw graph-lasso- "EmpiricalCovariance" [] {:store_precision store_precision :assume_centered assume_centered }))
