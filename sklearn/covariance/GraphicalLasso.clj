(ns sklearn.covariance.GraphicalLasso
...
(defn GraphicalLasso 
  ...
  [ & {:keys [alpha mode tol enet_tol max_iter verbose assume_centered]
   ...
   (py/call-attr-kw covariance "GraphicalLasso" [] {:alpha alpha :mode mode :tol tol :enet_tol enet_tol :max_iter max_iter :verbose verbose :assume_centered assume_centered }))
