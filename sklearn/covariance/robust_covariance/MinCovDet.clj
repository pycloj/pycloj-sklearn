(ns sklearn.covariance.robust-covariance.MinCovDet
...
(defn MinCovDet 
  "Minimum Covariance Determinant (MCD): robust estimator of covariance.
    ...
    "
  [ & {:keys [store_precision assume_centered support_fraction random_state]
       :or {store_precision true assume_centered false}} ]
  
   (py/call-attr-kw robust-covariance "MinCovDet" [] {:store_precision store_precision :assume_centered assume_centered :support_fraction support_fraction :random_state random_state }))
