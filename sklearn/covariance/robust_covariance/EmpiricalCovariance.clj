(ns sklearn.covariance.robust-covariance.EmpiricalCovariance
...
(defn EmpiricalCovariance 
  ...
  [ & {:keys [store_precision assume_centered]
   ...
   (py/call-attr-kw robust-covariance "EmpiricalCovariance" [] {:store_precision store_precision :assume_centered assume_centered }))
