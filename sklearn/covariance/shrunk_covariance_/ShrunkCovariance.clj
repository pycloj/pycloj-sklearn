(ns sklearn.covariance.shrunk-covariance-.ShrunkCovariance
...
(defn ShrunkCovariance 
  "Covariance estimator with shrinkage
    ...
    "
  [ & {:keys [store_precision assume_centered shrinkage]
       :or {store_precision true assume_centered false shrinkage 0.1}} ]
  
   (py/call-attr-kw shrunk-covariance- "ShrunkCovariance" [] {:store_precision store_precision :assume_centered assume_centered :shrinkage shrinkage }))
