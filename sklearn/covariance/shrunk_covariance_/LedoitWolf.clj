(ns sklearn.covariance.shrunk-covariance-.LedoitWolf
...
(defn LedoitWolf 
  ...
  [ & {:keys [store_precision assume_centered block_size]
   ...
   (py/call-attr-kw shrunk-covariance- "LedoitWolf" [] {:store_precision store_precision :assume_centered assume_centered :block_size block_size }))
