(ns sklearn.neighbors.kde.KernelDensity
...
(defn KernelDensity 
  ...
  [ & {:keys [bandwidth algorithm kernel metric atol rtol breadth_first leaf_size metric_params]
   ...
   (py/call-attr-kw kde "KernelDensity" [] {:bandwidth bandwidth :algorithm algorithm :kernel kernel :metric metric :atol atol :rtol rtol :breadth_first breadth_first :leaf_size leaf_size :metric_params metric_params }))
