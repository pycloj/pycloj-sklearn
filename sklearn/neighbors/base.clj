...
(defn effective-n-jobs 
  ...
  [ & {:keys [n_jobs]
   ...
   (py/call-attr-kw base "effective_n_jobs" [] {:n_jobs n_jobs }))
...
(defn gen-even-slices 
  "Generator to create n_packs slices going up to n.
    ...
    "
  [ n n_packs n_samples ]
  (py/call-attr base "gen_even_slices"  n n_packs n_samples ))
...
(defn pairwise-distances-chunked 
  ...
  [X Y reduce_func & {:keys [metric n_jobs working_memory]
                       :or {metric "euclidean"}} ]
    (py/call-attr-kw base "pairwise_distances_chunked" [X Y reduce_func] {:metric metric :n_jobs n_jobs :working_memory working_memory }))
