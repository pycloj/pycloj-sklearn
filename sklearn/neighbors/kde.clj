...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw kde "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn check-consistent-length 
  "Check that all arrays have consistent first dimensions.
    ...
    *arrays : list or tuple of input objects.
    ...
    "
  [  ]
  (py/call-attr kde "check_consistent_length"  ))
...
(defn check-random-state 
  "Turn seed into a np.random.RandomState instance
    ...
    "
  [ seed ]
  (py/call-attr kde "check_random_state"  seed ))
...
(defn row-norms 
  ...
  [X & {:keys [squared]
                       :or {squared false}} ]
    (py/call-attr-kw kde "row_norms" [X] {:squared squared }))
