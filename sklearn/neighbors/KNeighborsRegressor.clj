(ns sklearn.neighbors.KNeighborsRegressor
...
(defn KNeighborsRegressor 
  ...
  [ & {:keys [n_neighbors weights algorithm leaf_size p metric metric_params n_jobs]
   ...
   (py/call-attr-kw neighbors "KNeighborsRegressor" [] {:n_neighbors n_neighbors :weights weights :algorithm algorithm :leaf_size leaf_size :p p :metric metric :metric_params metric_params :n_jobs n_jobs }))
