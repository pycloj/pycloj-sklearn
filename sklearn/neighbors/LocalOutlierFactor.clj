(ns sklearn.neighbors.LocalOutlierFactor
...
(defn LocalOutlierFactor 
  ...
  [ & {:keys [n_neighbors algorithm leaf_size metric p metric_params contamination novelty n_jobs]
   ...
   (py/call-attr-kw neighbors "LocalOutlierFactor" [] {:n_neighbors n_neighbors :algorithm algorithm :leaf_size leaf_size :metric metric :p p :metric_params metric_params :contamination contamination :novelty novelty :n_jobs n_jobs }))
