(ns sklearn.neighbors.NeighborhoodComponentsAnalysis
...
(defn NeighborhoodComponentsAnalysis 
  ...
  [n_components & {:keys [init warm_start max_iter tol callback verbose random_state]
    ...
    (py/call-attr-kw neighbors "NeighborhoodComponentsAnalysis" [n_components] {:init init :warm_start warm_start :max_iter max_iter :tol tol :callback callback :verbose verbose :random_state random_state }))
