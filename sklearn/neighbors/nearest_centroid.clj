(ns sklearn.neighbors.nearest-centroid
  "
...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw nearest-centroid "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn check-classification-targets 
  "Ensure that target y is of a non-regression type.
    ...
    "
  [ y ]
  (py/call-attr nearest-centroid "check_classification_targets"  y ))
...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw nearest-centroid "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn csc-median-axis-0 
  "Find the median across axis 0 of a CSC matrix.
    ...
    "
  [ X ]
  (py/call-attr nearest-centroid "csc_median_axis_0"  X ))
...
(defn pairwise-distances 
  ...
  [X Y & {:keys [metric n_jobs]
                       :or {metric "euclidean"}} ]
    (py/call-attr-kw nearest-centroid "pairwise_distances" [X Y] {:metric metric :n_jobs n_jobs }))
