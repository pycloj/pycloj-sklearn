...
(defn Memory 
  ...
  [location & {:keys [backend cachedir mmap_mode compress verbose bytes_limit backend_options]
    ...
    (py/call-attr-kw validation "Memory" [location] {:backend backend :cachedir cachedir :mmap_mode mmap_mode :compress compress :verbose verbose :bytes_limit bytes_limit :backend_options backend_options }))
