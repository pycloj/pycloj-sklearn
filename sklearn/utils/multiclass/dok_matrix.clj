(ns sklearn.utils.multiclass.dok-matrix
  "
...
(defn dok-matrix 
  ...
  [arg1 shape dtype & {:keys [copy]
                       :or {copy false}} ]
    (py/call-attr-kw multiclass "dok_matrix" [arg1 shape dtype] {:copy copy }))
...
(defn conjtransp 
  ...
  [ self  ]
  (py/call-attr self "conjtransp"  self  ))
...
(defn update 
  ""
  [ self val ]
  (py/call-attr self "update"  self val ))
