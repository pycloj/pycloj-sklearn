...
(defn logsumexp 
  ...
  [a axis b & {:keys [keepdims return_sign]
    ...
    (py/call-attr-kw fixes "logsumexp" [a axis b] {:keepdims keepdims :return_sign return_sign }))
...
(defn pinvh 
  ...
  [a cond rcond & {:keys [lower return_rank check_finite]
    ...
    (py/call-attr-kw fixes "pinvh" [a cond rcond] {:lower lower :return_rank return_rank :check_finite check_finite }))
