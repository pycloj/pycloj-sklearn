...
(defn check-is-fitted 
  ...
  [estimator attributes msg & {:keys [all_or_any]
    ...
    (py/call-attr-kw validation "check_is_fitted" [estimator attributes msg] {:all_or_any all_or_any }))
...
(defn check-scalar 
  ...
  (py/call-attr validation "check_scalar"  x name target_type min_val max_val ))
