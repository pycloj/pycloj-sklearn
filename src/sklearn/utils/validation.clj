...
(defn as-float-array 
  ...
  [X & {:keys [copy force_all_finite]
    ...
    (py/call-attr-kw validation "as_float_array" [X] {:copy copy :force_all_finite force_all_finite }))
...
(defn assert-all-finite 
  ...
  [X & {:keys [allow_nan]
                       :or {allow_nan false}} ]
    (py/call-attr-kw validation "assert_all_finite" [X] {:allow_nan allow_nan }))
...
(defn check-array 
  ...
  [array & {:keys [accept_sparse accept_large_sparse dtype order copy force_all_finite ensure_2d allow_nd ensure_min_samples ensure_min_features warn_on_dtype estimator]
    ...
    (py/call-attr-kw validation "check_array" [array] {:accept_sparse accept_sparse :accept_large_sparse accept_large_sparse :dtype dtype :order order :copy copy :force_all_finite force_all_finite :ensure_2d ensure_2d :allow_nd allow_nd :ensure_min_samples ensure_min_samples :ensure_min_features ensure_min_features :warn_on_dtype warn_on_dtype :estimator estimator }))
...
(defn check-is-fitted 
  "Perform is_fitted validation for estimator.
    ...
    "
  [estimator attributes & {:keys [msg all_or_any]
                       :or {all_or_any <built-in function all>}} ]
    (py/call-attr-kw validation "check_is_fitted" [estimator attributes] {:msg msg :all_or_any all_or_any }))
...
(defn check-memory 
  "Check that ``memory`` is joblib.Memory-like.
    ...
    "
  [ memory ]
  (py/call-attr validation "check_memory"  memory ))
...
(defn check-non-negative 
  "
    ...
    "
  [ X whom ]
  (py/call-attr validation "check_non_negative"  X whom ))
...
(defn check-random-state 
  "Turn seed into a np.random.RandomState instance
    ...
    "
  [ seed ]
  (py/call-attr validation "check_random_state"  seed ))
(defn check-scalar 
  "Validate scalar parameters type and value.
    ...
    "
  [x name target_type  & {:keys [min_val max_val]} ]
    (py/call-attr-kw validation "check_scalar" [x name target_type] {:min_val min_val :max_val max_val }))
...
(defn check-symmetric 
  ...
  [array & {:keys [tol raise_warning raise_exception]
    ...
    (py/call-attr-kw validation "check_symmetric" [array] {:tol tol :raise_warning raise_warning :raise_exception raise_exception }))
...
(defn column-or-1d 
  ...
  [y & {:keys [warn]
                       :or {warn false}} ]
    (py/call-attr-kw validation "column_or_1d" [y] {:warn warn }))
...
(defn has-fit-parameter 
  "Checks whether the estimator's fit method supports the given parameter.
    ...
    "
  [ estimator parameter ]
  (py/call-attr validation "has_fit_parameter"  estimator parameter ))
...
(defn signature 
  ...
  [obj & {:keys [follow_wrapped]
    ...
    (py/call-attr-kw validation "signature" [obj] {:follow_wrapped follow_wrapped }))
