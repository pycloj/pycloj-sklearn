...
(defn comb 
  "The number of combinations of N things taken k at a time.
    ...
    "
  [ & {:keys [N k exact repetition]
       :or {exact false repetition false}} ]
  
   (py/call-attr-kw fixes "comb" [] {:N N :k k :exact exact :repetition repetition }))
...
(defn logsumexp 
  "Compute the log of the sum of exponentials of input elements.
    ...
    "
  [ & {:keys [a axis b keepdims return_sign]
       :or {keepdims false return_sign false}} ]
  
   (py/call-attr-kw fixes "logsumexp" [] {:a a :axis axis :b b :keepdims keepdims :return_sign return_sign }))
...
(defn parallel-helper 
  "Workaround for Python 2 limitations of pickling instance methods
    ...
    **kwargs
    ...
    "
  [ & {:keys [obj methodname]} ]
   (py/call-attr-kw fixes "parallel_helper" [] {:obj obj :methodname methodname }))
...
(defn pinvh 
  "
    ...
    "
  [ & {:keys [a cond rcond lower return_rank check_finite]
       :or {lower true return_rank false check_finite true}} ]
  
   (py/call-attr-kw fixes "pinvh" [] {:a a :cond cond :rcond rcond :lower lower :return_rank return_rank :check_finite check_finite }))
...
(defn sparse-lsqr 
  "Find the least-squares solution to a large, sparse, linear system
    ...
    "
  [ & {:keys [A b damp atol btol conlim iter_lim show calc_var x0]
       :or {damp 0.0 atol 1e-08 btol 1e-08 conlim 100000000.0 show false calc_var false}} ]
  
   (py/call-attr-kw fixes "sparse_lsqr" [] {:A A :b b :damp damp :atol atol :btol btol :conlim conlim :iter_lim iter_lim :show show :calc_var calc_var :x0 x0 }))
