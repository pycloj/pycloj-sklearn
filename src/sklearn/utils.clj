...
(defn check-scalar 
  ...
  [x name target_type  & {:keys [min_val max_val]} ]
    (py/call-attr-kw utils "check_scalar" [x name target_type] {:min_val min_val :max_val max_val }))
...
(defn compute-sample-weight 
  "Estimate sample weights by class for unbalanced datasets.
    ...
    "
  [class_weight y  & {:keys [indices]} ]
    (py/call-attr-kw utils "compute_sample_weight" [class_weight y] {:indices indices }))
...
Decorator used to capture the arguments of a function."
  [function  & {:keys [check_pickle]} ]
    (py/call-attr-kw utils "delayed" [function] {:check_pickle check_pickle }))
...
(defn gen-even-slices 
  "Generator to create n_packs slices going up to n.
    ...
    "
  [n n_packs  & {:keys [n_samples]} ]
    (py/call-attr-kw utils "gen_even_slices" [n n_packs] {:n_samples n_samples }))
(defn get-chunk-n-rows 
  "Calculates how many rows can be processed within working_memory
    ...
    "
  [row_bytes  & {:keys [max_n_rows working_memory]} ]
    (py/call-attr-kw utils "get_chunk_n_rows" [row_bytes] {:max_n_rows max_n_rows :working_memory working_memory }))
